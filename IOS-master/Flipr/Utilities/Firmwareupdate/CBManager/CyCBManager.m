...
//        [cbDiscoveryDelegate bluetoothStateUpdatedToState:YES];
        if (self.cbDiscoveryDelegate && [self.cbDiscoveryDelegate respondsToSelector:@selector(bluetoothStateUpdatedToState:)]) {
            [cbDiscoveryDelegate bluetoothStateUpdatedToState:YES];
        }
...
-(void)redirectToRootViewController
{
    if(cbDiscoveryDelegate)
    {
        ...
        [[NSNotificationCenter defaultCenter]
            postNotificationName:@"DisconncetionDevice"
            object:self];
...
//            [cbDiscoveryDelegate bluetoothStateUpdatedToState:NO];
            ...
            [[NSNotificationCenter defaultCenter]
                postNotificationName:@"BluetoothDisconncetion"
                object:self];
...
//            [cbDiscoveryDelegate bluetoothStateUpdatedToState:YES];
            [[NSNotificationCenter defaultCenter]
                postNotificationName:@"BluetoothConncetionOn"
                object:self];
            if (self.cbDiscoveryDelegate && [self.cbDiscoveryDelegate respondsToSelector:@selector(bluetoothStateUpdatedToState:)]) {
                [cbDiscoveryDelegate bluetoothStateUpdatedToState:YES];
            }
