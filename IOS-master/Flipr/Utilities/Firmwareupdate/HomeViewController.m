 ...
 *
 */
@interface HomeViewController ()<UITableViewDataSource, UITableViewDelegate, cbDiscoveryManagerDelegate, UISearchBarDelegate,cbCharacteristicManagerDelegate>
{
...
//    [self addSearchButtonToNavBar];
    [[self navBarTitleLabel] setText:@"Upgrade Flipr"];
...
{
    isBluetoothON = FALSE;
    self.iconImageView.image = [UIImage imageNamed:@"firmwareBLEError"];
...
{
    isBluetoothON = TRUE;
    self.iconImageView.image = [UIImage imageNamed:@"languer"];
    self.descLabel.text = LOCALIZEDSTRING(@"The update instructions.");
