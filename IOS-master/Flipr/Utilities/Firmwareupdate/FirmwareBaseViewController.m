...
/*!
 *  @class FirmwareBaseViewController
 *
 ...
 *
 */
@interface FirmwareBaseViewController () < UISearchBarDelegate>
{
...
@implementation FirmwareBaseViewController
...
-(void) addNavigationBarView
{
    ...
    self.navigationController.navigationBar.backgroundColor = [UIColor colorWithRed:0.33 green:0.52 blue:0.65 alpha:1.0];
    //BLUE_COLOR;
    

    
    CGRect labelFrame = CGRectMake(0, 0, 300, NAV_BAR_HEIGHT);
...
-(void) addSearchButtonToNavBar
{
    ...
    CGRect titleFrame = CGRectMake(0, 0, 300, NAV_BAR_HEIGHT);
...
//            }
            ...
            if (sself->isTitleViewSearchBar) {
                ...
                sself.navBarTitleLabel.frame = CGRectMake(0, 0, 300, NAV_BAR_HEIGHT);
